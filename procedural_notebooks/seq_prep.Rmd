...
# add columns to seq db (only have to do this once today)
dat_db <- dat_db %>% 
  mutate(vol_pooled_libs = NA, vol_TE = NA)
dat_db <- dat_db %>% 
  select(seq_id:contents, vol_pooled_libs, vol_TE, library_type:notes)
#____________________________________________________________
