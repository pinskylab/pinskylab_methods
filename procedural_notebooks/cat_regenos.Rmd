...
if (grepl(params$seq, list(x$SEQ))){
  ...
  y <- paste0("/local/home/michelles/02-apcl-ddocent/", x$SEQ[1], "/samples/APCL_", x$ligation_id[1], ".F.fq.gz")
  z <- paste0("/local/home/michelles/02-apcl-ddocent/", x$SEQ[2], "/samples/APCL_", x$ligation_id[2], ".F.fq.gz")
  a <- paste0("/local/home/michelles/02-apcl-ddocent/", params$dir, "/samples/",  "APCL_",x$ligation_id[1], ".", x$ligation_id[2], ".F.fq.gz")
  ...
  y <- paste0("/local/home/michelles/02-apcl-ddocent/", x$SEQ[1], "/samples/APCL_", x$ligation_id[1], ".F.fq.gz")
  z <- paste0("/local/home/michelles/02-apcl-ddocent/", x$SEQ[2], "/samples/APCL_", x$ligation_id[2], ".F.fq.gz")
  c <- paste0("/local/home/michelles/02-apcl-ddocent/", x$SEQ[3], "/samples/APCL_", x$ligation_id[3], ".F.fq.gz")
  a <- paste0("/local/home/michelles/02-apcl-ddocent/", params$dir, "/samples/",  "APCL_", x$ligation_id[1], ".", x$ligation_id[2], ".", x$ligation_id[3], ".F.fq.gz")
...
for (i in 1:nrow(regenos))  {
  ...
  if (grepl(params$seq, list(x$SEQ))){
    ...
    for (j in 1:nrow(x)){
      # construct the pieces for the line of code
      y <- paste0("/local/home/michelles/02-apcl-ddocent/", x$SEQ[j], "/samples/APCL_", x$ligation_id[j], "*")
      a <- paste0("/local/home/michelles/02-apcl-ddocent/", x$SEQ[j], "/samples/regenos/")
      b <- paste("mv", y, a, sep = " ")
