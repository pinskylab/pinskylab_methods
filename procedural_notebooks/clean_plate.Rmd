...
2. Bring `r paste(params$vol_samples * params$num_samples * 1.5/1000, "mL", sep = " ")`  of AMPure to room temperature - takes about 5 minutes depending on temperature of lab.  
