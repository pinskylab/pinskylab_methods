...
```{bash}
mkdir /local/shared/pinskylab/sequencing/hiseq_2018_09_17_SEQ18
```
...
[x]process_radtags - use esc-R or ctrl-\ to "find and replace" in nano - takes about 2.5 hours for 4 pools and 192 samples
