...
# infile <- "id_support/SNP.DP3g95p5maf05HM_seq_17_03.LDpruned.beta.noissues.IDfin.ident_1.txt"
infile <- "../../Identity/seq03-16_20160718_ID_all.csv"

# Import cervus identity results ------------------------------------------
idcsv <- read.csv(infile, stringsAsFactors = F)
