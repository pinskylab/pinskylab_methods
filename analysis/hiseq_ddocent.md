...
5. [Run dDocent on a species for the first time] or [Add samples to an existing dataset in dDocent on amphiprion](./add_ddocent.md) - the first round to trim and map takes about 3 hours and the second round to call SNPs takes about 5 days
