...
4. Restrict the data to variants called in a high percentage of individuals (95%) and filter by mean depth of genotypes (20). For identity analysis and parentage, use an maf of 0.2, which is a more strict cutoff, reducing the number of loci to alleles found in a larger proportion of the population.
