...
1. ggsave(plot, "filename.pdf") - will save the object called plot into the working directory.  
1. ggsave(plot, here::here("plots", "filename.pdf")) - will save the object called plot into the plots folder that is closest to your working directory.